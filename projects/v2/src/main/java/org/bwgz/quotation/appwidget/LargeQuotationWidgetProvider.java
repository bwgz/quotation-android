...
public class LargeQuotationWidgetProvider extends AppWidgetProvider {
    static private final String TAG = LargeQuotationWidgetProvider.class.getSimpleName();
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        intent.putExtra(QuotationWidgetService.EXTRA_UPDATE_LAYOUT_ID, R.layout.quotation_widget_large);
